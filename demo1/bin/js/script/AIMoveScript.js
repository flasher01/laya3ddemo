...
var AIMoveScript = /** @class */ (function (_super) {
    ...
    AIMoveScript.prototype.stopFindPath = function () {
        this._moveTween.pause();
    };
    AIMoveScript.prototype.resumeFindPath = function () {
    ...
    AIMoveScript.prototype._findTargetPos = function () {
        ...
        var time = Math.sqrt((this._pathX - this._pAgentSprite2D.x) * (this._pathX - this._pAgentSprite2D.x) + (this._pathY - this._pAgentSprite2D.y) * (this._pathY - this._pAgentSprite2D.y)) / this._pCharacter.data.speed;
    ...
    AIMoveScript.prototype._convert2DPosTo3D = function () {
