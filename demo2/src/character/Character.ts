class Character extends Laya.Sprite3D {
    ...
    private _fireBodyMaterial(sp3d) {
        ...
        if (sp3d instanceof Laya.SkinnedMeshSprite3D) {
            ...
            material.diffuseTexture = (cloneSp.skinnedMeshRender.material as Laya.StandardMaterial).diffuseTexture;
            ...
            material.diffuseTexture = (cloneSp.meshRender.material as Laya.StandardMaterial).diffuseTexture;
