var Level = /** @class */ (function () {
    ...
    Level.prototype._scene3dComplete = function () {
        var _this = this;
        LoaderManager.instance.loadImage2D([
            ...
            _this._loadCharacter();
        }, "加载场景中");
    };
    Level.prototype._loadCharacter = function () {
        var urlArr = [];
    ...
    Level.prototype._characterLoadComplete = function () {
        ...
        // }
        for (var i = 0; i < 3; i++) {
            Laya.Pool.recover("FX_1", Laya.loader.getRes("res/fx/3d/1/1.lh").clone());
            Laya.Pool.recover("FX_2", Laya.loader.getRes("res/fx/3d/2/1.lh").clone());
        }
